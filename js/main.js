  ...
  document.addEventListener("click", () => {
    if (event.target.classList.contains("link-item")) {
      ...
      if (event.target.hash != "") {
        ...
        event.preventDefault();        const hash = event.target.hash;
        // deactivate existing hash section
...
(() => {
  ...
  tabsContainer.addEventListener("click", (event) => {
    ...
    /* -------if event.target contains 'tab-item' and not contains
    'active' class--------*/
    ...
    if (event.target.classList.contains("tab-item") &&
      ...
      // aboutSection.querySelector(".education tab-content.active").classList.remove("active");
...
(() => {
  ...
  portfolioItemsContainer.addEventListener("click", (event) => {
    if (event.target.closest(".portfolio-item-inner")) {
      ...
      // get the portfolioItem itemIndex
  ...
  function popupDetails() {
    ...
    if (!portfolioItems[itemIndex].querySelector(
